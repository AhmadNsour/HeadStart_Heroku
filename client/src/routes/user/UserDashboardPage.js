...
export default class UserDashboardPage extends Component {
  ...
  getPosts() {
    axios
      .post("/get-user-posts", this.props.loggedInUser)
      .then(res => {
  ...
  getComments() {
    axios
      .post("/get-user-comments", this.props.loggedInUser)
      .then(res => {
  ...
  deleteComment = _id => {
    ...
    axios
      .post("/delete-user-comment", { _id, user_id })
      .then(res => {
        this.setState({ comments: res.data });
      });
  };
  ...
  deletePending = _id => {
    let user_id = this.props.loggedInUser._id;
    axios
      .post("/delete-pending", { _id, user_id })
      .then(res => {
        this.getPendings();
      });
  };
